...
ALL_IP = {
    "172.20.10.1": [50003, 250, 250, 0, 0, 3],
    "172.20.10.2": [50004, 350, 350, 1, 1, 5],
    "172.20.10.3": [50003, 250, 250, 0, 0, 3],
    "172.20.10.4": [50004, 350, 350, 1, 1, 5],
    "172.20.10.5": [50004, 350, 350, 1, 1, 5],
    "172.20.10.6": [50004, 350, 350, 1, 1, 5],
    "172.20.10.7": [50005, 500, 500, 2, 0, 4],
    "172.20.10.8": [50005, 500, 500, 2, 0, 4],
    "172.20.10.9": [50005, 500, 500, 2, 0, 4],
    "172.20.10.10": [50006, 650, 650, 0, 0, 5],
    "172.20.10.11": [50006, 650, 650, 0, 0, 5],
    "172.20.10.12": [50006, 650, 650, 0, 0, 5],
    "172.20.10.13": [50007, 800, 800, 1, 0, 6],
    "172.20.10.14": [50007, 800, 800, 1, 0, 6],
    "172.20.10.15": [50007, 800, 800, 1, 0, 6]
}

SELECTED_IP = None

mode = ["Lean", "Mean", "Marines"]
style_map = ["Normal", "Centered"]
